...
export async function fetchUsers (): Promise<UserEntity[]> {
    const req = await fetch('http://localhost:8100/users',{
        next: { tags: ['users'] }
    });
...
export async function fetchUserById(id: number): Promise<UserEntity> {
    const req = await fetch(`http://localhost:8100/users/${id}`, {
        next: { tags: ['users'] }
    });
    return await req.json();
}

export async function fetchTimeStudiedByAnUser(id: number): Promise<number> {
    const req = await fetch(`http://localhost:8100/users/time-studied/${id}`, {
        next: { tags: ['users'] }
    });
    return await req.json();
}
...
export async function fetchSubjects(): Promise<SubjectEntity[]> {
    const req = await fetch('http://localhost:8100/subjects', {
        next: { tags: ['subjects'] }
    });
    return await req.json();
};
...
export async function deleteSubject(id: number): Promise<void> {
    await fetch(`http://localhost:8100/subjects/${id}`, {
        method: 'DELETE',
        next: {tags: ['subjects']}
    });
}
...
export async function fetchSessions(): Promise<SubjectSessionEntity[]> {
    const req = await fetch('http://localhost:8100/subject-session', {
        next: { tags: ['subjects'] }
    });
    return await req.json();
};
...
export async function startSessionTimer(id: number): Promise<void> {
    await fetch(`http://localhost:8100/subject-session/${id}/start`, {
        method: 'PUT',
...
export async function endSessionTimer(id: number): Promise<void> {
    await fetch(`http://localhost:8100/subject-session/${id}/end`, {
        method: 'PUT',
        next: { tags: ['subject-session'] }
    });
}
...
export async function deleteSessions(id: number): Promise<void> {
    await fetch(`http://localhost:8100/subject-session/${id}`, {
        method: 'DELETE',
        next: {tags: ['subject-session']}
    });
}
...
export async function fetchSessionDuration(id: number): Promise<number> {
    const req = await fetch(`http://localhost:8100/subject-session/duration/${id}`, {
        next: { tags: ['subject-session'] }
    });
    return await req.json();
};
...
export async function fetchNumberOfSessionsForAnSubject(id:number): Promise<number>{
    const req = await fetch(`http://localhost:8100/subjects/number-of-sessions/${id}`, {
        next: { tags: ['subject-session'] }
    });
    return await req.json();
}
...
export async function fetchTimeAllottedForAnSubject(id:number): Promise<number>{
    const req = await fetch(`http://localhost:8100/subjects/total-time-allotted/${id}`, {
        next: { tags: ['subject-session'] }
    });
    return await req.json();
}